...
if [[ $identity_only == false ]]; then
  ...
  for optional_name in SANDBOX_MAX SANDBOX_MEMORY SANDBOX_CPUS SANDBOX_PIDS_LIMIT SANDBOX_IDLE_TTL_SECONDS LEASE_SECONDS VERCEL_PROTECTION_BYPASS WORK_DELAY_MS SANDBOX_SYNC STORAGE_API_URL CHAIN_ID DATA_REGISTRY_CONTRACT DATA_PORTABILITY_SERVER_CONTRACT DATA_PORTABILITY_GRANTEES_CONTRACT DATA_PORTABILITY_PERMISSIONS_CONTRACT; do
